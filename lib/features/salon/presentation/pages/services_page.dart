...
class ServicesPage extends StatefulWidget {
  ...
  const ServicesPage({super.key, required this.products});
...
class ServicesPageState extends State<ServicesPage> {
  List<SalonModel> filteredServices = [];
  bool isGrid = false;

  @override
  void initState() {
    filteredServices = widget.products;
    super.initState();
  }
        ...
        children: [
          Expanded(
            child: GridView.builder(
              ...
              itemCount: /*filteredServices.length*/ 20,
              itemBuilder: (context, index) {
                return SalonCard(
                  salon: filteredServices[index],
                );
              },
            ),
          ),
